...
*/
VariogramDialog1d::VariogramDialog1d(QWidget *parent,bool genexp, QString range, QString power) : QDialog(parent){
	setupUi( this );
...
QList<QString> VariogramDialog1d::variogramValues(){
...
void VariogramDialog1d::on_buttonBox_accepted() {
...
void VariogramDialog1d::on_genexpRadioButton_toggled(bool checked){
        powerLabel->setEnabled(true);
        powerLineEdit->setEnabled(true);

}
void VariogramDialog1d::on_sphericalRadioButton_toggled(bool checked){
        powerLineEdit->clear();
