 ...
 ***************************************************************************/
#ifndef VARIOGRAMDIALOG1D_H
#define VARIOGRAMDIALOG1D_H

#include "ui_VariogramDialog1d.h"

#include "Main_crava.h"

/**
	@author Alf Birger Rustad (Statoil R&D) <abir@statoil.com>
*/
class VariogramDialog1d : public QDialog, private Ui::VariogramDialog1d{
	Q_OBJECT

public:
        //constructor, makes sure that the values in the dialog match the values in the tree
	VariogramDialog1d(QWidget *parent =0,bool genexp=true, QString range=QString(), QString power=QString());
